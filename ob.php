...
<html lang="en-US" dir="ltr">
 ...
 <?php include "ob_page_properties/header.php" ?>
  ...
  <body>
    ...
    <main class="main" id="top">
      <!-- navigation -->
      <?php include "ob_page_properties/homepage_main_nav.php";?>
      <?php include "ob_page_properties/homepage_sub_nav.php";?>
      <!-- /navigation -->
      <div class="content">
        <?php 
    ...
    <?php include "ob_page_properties/footer_main.php"; ?>
  </body>
