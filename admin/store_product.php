        ...
        <div style="background-color: white; height: auto;" class="rounded border p-3 mb-3 w-100">
                <div class="border rounded mt-2 p-3">
                    ...
                    <div style="display: flex; flex-direction: row; justify-content: space-between" class="mb-3">
                        ...
                        <div class="form-floating" style="width: 32%; margin: 0px 5px 0px 5px" >
                            <input type="text" id="transaction_customer_name" value="<?php echo $row['material_inspected_by']; ?>" class="form-control" placeholder="" readonly>
                            <label for="transaction_customer_name">Inpected by:</label>
                        </div>
                        <div class="form-floating" style="width: 32%; margin: 0px 5px 0px 5px" >
                            <input type="text" id="transaction_customer_name" value="<?php echo $row['material_verified_by']; ?>" class="form-control" placeholder="" readonly>
