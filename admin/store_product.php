...
$products = "SELECT `id`, `product_name` FROM `product`";
    ...
    <div>
        ...
        <div style="background-color: white; height: auto;" class="rounded border p-3 mb-3 w-100">
            ...
            <div class="border rounded mt-2 p-3" >
                    <div style="display: flex; flex-direction: row; justify-content: space-between">
                        <div>
                            <h4>Total Cost: PHP 100.00</h4>
                            <h4>Total Markup: PHP 100.00</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body " style="display: flex; flex-direction: column; align-items: center; justify-content: center">
        ...
        <input type="text" id="product_search" class="form-control mb-2" placeholder="Search for a product">
        <input type="hidden" id="product_id" name="product_id">

        

        <div class="input-group mb-2">
            <span class="input-group-text w-25" id="basic-addon1">Current Price </span>
