        ...
        <div style="background-color: white; height: 90vh;" class="rounded border p-3 mb-3 w-100">
            <div class="row">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;"> 
                    ...
                    <div>
                        <button class="btn border btn-sm rounded" data-bs-toggle="modal" data-bs-target="#add_product">+ Add Product</button>
                    </div>
                </div>
                <div class="p-1">
                    <table class="table mt-3">
                        <thead>
                            <tr>
                            <td scope="col" width="10%" class="product_id">Product Id</td>
                            <td scope="col" width="20%" class="product_img">Image</td>
                            <td scope="col" width="40%">Product Name</td>
                            <td scope="col" width="10%">Stocks</td>
                            <td scope="col" width="20%" class="text-end">Action</td>
                            </tr>
                        </thead>
                        <tbody>
                        <tr>
                                <td scope="row" class="product_id">PROD001</td>
                                <td class="product_img">IMG001</td>
                                <td>Carburator Honda</td>
                                <td>100 pcs</td>
                                <td class="text-end">
