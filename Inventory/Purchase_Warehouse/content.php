            ...
            <div class="d-flex flex-row">
                <div class="search-box ">
                    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                        <input class="form-control search-input search border border-primary " type="search" placeholder="Search" aria-label="Search">
                ...
                <button class="btn ms-2 border-primary text-primary border" type="button" data-bs-toggle="modal" data-bs-target="#add_product"><span class="fas fa-plus me-2"></span>Add New Product</button>
            </div>
