    ...
    <div id="products" data-list='{"valueNames":["product","itemcode", "location", "category", "brand", "unit", "model", "qty", "status", "publishby", "branch"],"page":10,"pagination":true}'>
        <div class="mb-4">
            ...
            <div class="ms-xxl-auto">
                ...
                <a href="../barcode_scanner/" class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#add_product"><span class="fas fa-plus me-2"></span>Add product</a>
            </div>
            </div>
        </div>
