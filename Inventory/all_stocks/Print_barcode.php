    ...
    <div class="col-lg-12 p-3 border bbg m-1" style="width: 100vh;">
        <div class="row">
            <div class="col-lg-12 p-1">
                ...
                <p class="m-0" style="font-size: 5;">Model: <?php  echo $model; ?></p>
            </div>
            <div class="col-lg-12 ps-4 text-center pt-2 mb-2">
                <img src="../../assets/php-barcode-master/barcode.php?codetype=Code128&size=20&text=<?php echo $barcode;?>&print=true" class="img img-fluid">
            </div>
        </div>
    </div>
    <?php
