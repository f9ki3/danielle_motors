...
<div class="d-flex align-content-end flex-wrap" >
    ...
    <div class="col-lg-12 p-3 border bbg m-1" style="width: 100vh;">
        <div class="row">
            <div class="col-lg-12 p-1" hidden>
            ...
            <div class="col-lg-12 ps-4 text-center pt-2 mb-2">
                <img src="../../assets/php-barcode-master/barcode.php?codetype=Code128&size=30&text=<?php echo $barcode;?>&print=true" class="img img-fluid" style="width: 90vh;">
            </div>
        </div>
    </div>
    <?php
