    ...
    function populateTable(data) {
        ...
        data.forEach(product => {
            ...
            row.innerHTML = `
                ...
                <td class="ps-4">${product.wholesale || ''}</td>
                <td class="ps-4">${product.srp || ''}</td>
                <td class="ps-4">${product.code || ''}</td>
                <td class="ps-4">${product.supplier_code || ''}</td>
                <td class="ps-3">${product.category_id || ''}</td>
                <td class="ps-4">${product.brand_id || ''}</td>
                <td class="ps-4">${product.unit_id || ''}</td>
                <td class="ps-4">${product.models || ''}</td>
                <td class="ps-4">${product.active == '1' ? 'Active' : 'Inactive'}</td>
                <td class="ps-4">${product.publish_by || ''}</td>
                <td class="pe-0 ps-4"></td>
            `;
