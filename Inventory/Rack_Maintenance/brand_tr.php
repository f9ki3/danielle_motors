<?php
    $query = 'SELECT publish_date, location_name, publish_by, status, id FROM ware_location ORDER BY id DESC';
    $stmt = $conn->prepare($query);
    $stmt->execute();
    $stmt->bind_result($date, $name, $author, $status, $rack_id);
    while ($stmt->fetch()) {
        if ($status = 1) {
            $active = 'active';
        } else {
                ...
                <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                    <div class="font-sans-serif btn-reveal-trigger position-static">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-2">
                            <a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#update_' . $rack_id  . '">Update</a>
                        <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger" href="../../PHP - process_files/delete.php?type=rack&id=' . $rack_id . '">Remove</a>
                        </div>
                    </div>
                </td>
            </tr>';
        ...
        echo '
            <div class="modal fade" id="update_' . $rack_id  . '" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-fullscreen-sm-down">
                    <form action="../../PHP - process_files/update.php?rack=1" method="post">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <input class="form-control" type="text" name="rack_id" value="' . $rack_id . '" required hidden>
                                    <div class="form-floating mb-3">
                                    <input class="form-control" type="text" name="rack_name" value="' . $name . '" required>
