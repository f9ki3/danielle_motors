...
<div class="mb-9" id="actualContent" style="display: none;">
    <div class="row g-3 mb-4">
        <div class="col-auto">
            <h2 class="mb-0">Supplier Products</h2>
        </div>
    </div>
    ...
    <div id="products" data-list='{"valueNames":["product","price","category","tags","models", "vendor","time", "hotdog"],"page":10,"pagination":true, "filter":{"key":"vendor"}}'>
        <div class="mb-4">
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="col-3">
                    <select class="form-select form-select-sm mb-3" data-list-filter="data-list-filter" data-choices="data-choices" data-options='{"removeItemButton":true,"placeholder":true}'>
                        ...
                        <?php include "supplier_options.php";?>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive scrollbar mx-n1 px-1">
                <table id="productsTable" class="table mb-0">
                    ...
                    <tr>
                        ...
                        <th class="sort white-space-nowrap align-middle  text-start" scope="col" data-sort="product">PRODUCT NAME</th>
                        <th class="sort align-middle text-start" scope="col" data-sort="price">BRAND</th>
                        <th class="sort align-middle text-start" scope="col" data-sort="category" >CATEGORY</th>
                        <th class="sort align-middle text-start" scope="col" data-sort="tags" >UNIT</th>
                        <th class="sort align-middle fs-0 text-start" data-sort="models" scope="col" >MODELS</th>
                        <th class="sort align-middle text-start" scope="col" data-sort="vendor">SUPPLIER</th>
                        <th class="sort align-middle text-end" scope="col" data-sort="time" >ORIGINAL PRICE</th>
                        <th class="sort align-middle text-start" scope="col" data-sort="hotdog">DATE ADDED</th>
                        <th class="sort text-end align-middle" scope="col"></th>
                    </tr>
                    </thead>
                    <tbody class="list" id="products-table-body">
                        <?php include "supplier_products_tr.php";?>
