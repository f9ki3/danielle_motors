...
<div id="content" style="display: none">
    <div class="row g-3 mb-4">
        <div class="col-auto">
            <h2 class="mb-0">Replace Warehouse</h2>
        </div>
    </div>
    <div id="products" data-list='{"valueNames":["transaction-code","price","category","tags","vendor","time","publish"],"page":10,"pagination":true}'>
        <div class="mb-4">
