            ...
            <div class="mb-4">
              <div class="d-flex flex-wrap gap-3">
                <div class="search-box">
                  <form class="position-relative" action="../Product_Listz copy/index.php" method="POST">
                    <?php 
...
<script>
  ...
  function fetchContent(page) {
    ...
    fetch(`api.php?page=${page}<?php if(isset($_POST['search'])){ echo "&search=" . $_POST['search'];}?>`)
