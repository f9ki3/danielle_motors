       ...
       <div class="mb-4">
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="ms-xxl-auto">
                    ...
                    <a href="../Warehouse_Reports_Daily" class="btn border text-primary border-primary position-relative"><span class="far fa-clock me-2"></span> Daily</a>
                    <a href="../Warehouse_Reports_Monthly" class="btn border text-primary border-primary position-relative"><span class="fas fa-calendar-alt me-2"></span> Monthly</a>
                    <a href="../Warehouse_Reports_Yearly" class="btn border text-primary border-primary position-relative"><span class="far fa-calendar-check me-2"></span> Yearly</a>
                </div>
            </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="staticBackdropLabel">Create Reports</h4>
