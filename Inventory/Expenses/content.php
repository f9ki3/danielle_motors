    ...
    <div id="products" data-list='{"valueNames":["product","price","category","tags","vendor","time","publish"],"page":5,"pagination":true}'>
        <div class="mb-4">
            ...
            <div class="ms-xxl-auto">
                ...
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#add_product"><span class="fas fa-plus me-2"></span>Add expense</button>
            </div>
            </div>
        </div>
            ...
            <div class="table-responsive scrollbar mx-n1 px-1">
                <table class="table mb-0">
                    ...
                    <tr>
                        ...
                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="product">DESCRIPTION</th>
                        <th class="sort align-middle text-start ps-4" scope="col" data-sort="price">DAILY/MONTHLY</th>
                        <th class="sort align-middle text-start ps-4" scope="col" data-sort="price">AMOUNT</th>
                        <th class="sort align-middle text-start ps-4" scope="col" data-sort="price">PUBLISH DATE</th>
                        <th class="sort align-middle text-start ps-4" scope="col" data-sort="category">PUBLISH BY</th>
