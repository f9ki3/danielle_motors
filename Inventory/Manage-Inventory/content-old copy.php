                ...
                <table class="table fs--1 mb-0">
                    ...
                    <tbody class="list" id="products-table-body">
                        ...
                        <tr class="position-static">
                            ...
                            <td class="product align-middle ps-4">9855B910H19</td>
                            <td class="price align-middle white-space-nowrap text-end fw-bold text-700 ps-4">Php 1039.00</td>
                            <td class="product align-middle ps-4 line-clamp-3 d-none">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor itaque rerum quam est maiores enim illum soluta mollitia unde recusandae commodi, sint neque sapiente, qui, atque vero dolorum laudantium quos.</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Muffler</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Purefoods</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Mio Soul i125</td>
                            ...
                            <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                <div class="font-sans-serif btn-reveal-trigger position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#barcode1">View barcode</a>
                        ...
                        <!-- modal for barcode -->
                        <div class="modal fade" id="barcode1" tabindex="-1" aria-hidden="true" style="display: none;">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <img alt='barcode' class="img-fluid" src='../../assets/php-barcode-master/barcode.php?codetype=Code128&size=100&text=222222222222222222222222222201&print=true'/>
                              </div>
                        ...
                        <tr class="position-static">
                            <td class="fs--1 align-middle">
                                <div class="form-check mb-0 fs-0">
                                    <input class="form-check-input itemCheckbox" id="itemCheckbox" type="checkbox" data-bulk-select-row='{"product":"Motorcycle Brake Lever","productImage":"/products/2.png","price":"$29.99","category":"Brake Parts","tags":["Brake","Lever","Motorcycle"],"star":false,"vendor":"Speedy Parts Inc","publishedOn":"Feb 29, 2024"}' />
                                </div>
                            </td>
                            <td class="align-middle white-space-nowrap py-0">
                                <a class="d-block border rounded-2" href="../landing/product-details.html">
                            ...
                            <td class="product align-middle ps-4">BRKLV-1001</td>
                            <td class="price align-middle white-space-nowrap text-end fw-bold text-700 ps-4">$29.99</td>
                            <td class="product align-middle ps-4 line-clamp-3 d-none">High-quality brake lever for motorcycles.</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Brake Parts</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Speedy Parts Inc</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Universal</td>
                            <td class="time align-middle white-space-nowrap text-600 ps-4">Feb 29, 2024</td>
                            <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                <div class="font-sans-serif btn-reveal-trigger position-static">
                                    <button class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs--2" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                                        <span class="fas fa-ellipsis-h fs--2"></span>
                        ...
                        <tr class="position-static">
                            <td class="fs--1 align-middle">
                                <div class="form-check mb-0 fs-0">
                                    <input class="form-check-input itemCheckbox" id="itemCheckbox" type="checkbox" data-bulk-select-row='{"product":"Motorcycle Chain and Sprocket Kit","productImage":"/products/3.png","price":"$99.99","category":"Drive Train","tags":["Chain","Sprocket","Kit","Motorcycle"],"star":false,"vendor":"Rider's Choice Gear","publishedOn":"Feb 29, 2024"}' />
                                </div>
                            </td>
                            <td class="align-middle white-space-nowrap py-0">
                                <a class="d-block border rounded-2" href="../landing/product-details.html">
                                    <img src="../../assets/img/products/3.png" alt="" width="53" />
                                </a>
                            </td>
                            <td class="product align-middle ps-4 fw-semi-bold line-clamp-3 mb-0">
                                Motorcycle Chain and Sprocket Kit
                            </td>
                            <td class="product align-middle ps-4">CHAINSPRKIT-2001</td>
                            <td class="price align-middle white-space-nowrap text-end fw-bold text-700 ps-4">$99.99</td>
                            <td class="product align-middle ps-4 line-clamp-3 d-none">Complete kit including chain and sprockets for motorcycle drive train.</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Drive Train</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Rider's Choice Gear</td>
                            <td class="category align-middle white-space-nowrap text-600 fs--1 ps-4 fw-semi-bold">Universal</td>
                            <td class="time align-middle white-space-nowrap text-600 ps-4">Feb 29, 2024</td>
                            <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                <div class="font-sans-serif btn-reveal-trigger position-static">
