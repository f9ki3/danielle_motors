            ...
            <div class="mb-4">
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <div class="ms-xxl-auto">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#add_category"><span class="fas fa-plus me-2"></span>Add category</button>
                    </div>
                </div>
            </div>
            <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1">
                ...
                <table class="table mb-0">
                    ...
                    <tr>
                        ...
                        <th class="sort white-space-nowrap align-middle" scope="col" data-sort="product">CATEGORY</th>
