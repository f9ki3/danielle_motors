...
<div id="content" style="display: none;">
    ...
    <div id="products" data-list="{&quot;valueNames&quot;:[&quot;product&quot;,&quot;price&quot;,&quot;category&quot;,&quot;tags&quot;,&quot;vendor&quot;,&quot;unit&quot;, &quot;model&quot;, &quot;status&quot;],&quot;page&quot;:10,&quot;pagination&quot;:true}">
        ...
        <div class="pt-5 mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1" style="height: 35vh;">
            <table class="table">
...
<script>
    function addToCart(productId, image, productName, supplierCode, brandName, unitName, models, srp, totalStocks) {
        ...
        if (existingItem) {
            ...
            // Render the cart items in the table body
            renderCartItems(cartItems);
        }
    }

    
    // Function to render cart items in the table body
    function renderCartItems(cartItems) {
        var tableBody = document.getElementById('table_body_cart');
        if (tableBody) {
            // Clear existing rows
            tableBody.innerHTML = '';

            // Loop through cart items and append rows to the table body
            ...
            <tr>
                ...
                <td style="color: ${totalAmount <= 0 ? 'red' : 'inherit'};">${new Intl.NumberFormat('en-PH', { style: 'currency', currency: 'PHP' }).format(item.totalAmount)}</td>
                <td>
