        ...
        <div style="background-color: white;" class="rounded border p-3 w-100">
            <div class="row">
                <div style="display: flex; justify-content: space-between; align-items: center;"> 
                    <div style="width: 100%">
                    <div id="add_stocks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div style="display: flex; flex-direction: row; width: 100%; justify-content: space-between">
                        ...
                        <div style="width: 50%" class="p-2">
                            <div class="border rounded p-4">
                                ...
                                <button id="cancelButton" class="btn border text-primary border-primary" style="width: 49%">Cancel</button>
            ...
            var SellingPrice = parseInt($(this).find('td:eq(5)').text()); // Assuming the quantity is in the sixth column
                    ...
                    swal({
                        ...
                        if (value) {
                            ...
                            window.location.href = "../Material_Transaction?material_transaction=" + materialInvoiceNo;
                        }
                    });
        });
