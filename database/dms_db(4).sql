...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2024 at 02:57 PM
...
(273, '2024-03-13', 'Accessories', 'admin', 1);
...
--
-- Table structure for table `delivery_receipt_content`
--

CREATE TABLE `delivery_receipt_content` (
  `id` int(11) NOT NULL,
...
INSERT INTO `price_list` (`id`, `product_id`, `dealer`, `wholesale`, `srp`) VALUES
(1, 11, 13000, 16000, 20000),
(2, 12, 6045, 7115, 9000),
(3, 13, 7161, 8430, 10550),
(4, 14, 4865, 5725, 7250);

-- --------------------------------------------------------

--
-- Table structure for table `price_list_cart`
--

CREATE TABLE `price_list_cart` (
  `id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `qty` int(11) NOT NULL,
  `srp` int(11) NOT NULL
...
(11, 'dmp ', '12345678958', '1234568', '', '../uploads/dmp-removebg-preview.png', 'MIO i1259, CB125', 1, 2, 1, 1),
(12, 'dmp ', '12345678958', '1234568', '', '../uploads/dmp-removebg-preview.png', 'MIO i1259, CB125', 1, 2, 1, 1);
...
INSERT INTO `supplier` (`id`, `supplier_name`, `supplier_logo`, `supplier_email`, `supplier_address`, `phone`, `status`) VALUES
(2, 'HIRC POWER DEVELOPMENT', 'dmpsupplierlogo65f125f57790ahirc-removebg-preview.png', 'Hircpowerdevelopment0@gmail.com', '338 Purok Santan Brgy. San Jose Plaridel Bulacan, Plaridel, Philippines', '09252071855', 1);
...
--
-- Indexes for table `delivery_receipt_content`
--
ALTER TABLE `delivery_receipt_content`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `price_list_cart`
--
ALTER TABLE `price_list_cart`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `delivery_receipt_content`
--
ALTER TABLE `delivery_receipt_content`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `price_list_cart`
--
ALTER TABLE `price_list_cart`
...
--
-- Constraints for table `delivery_receipt_content`
--
ALTER TABLE `delivery_receipt_content`
  ADD CONSTRAINT `delivery_receipt_content_ibfk_1` FOREIGN KEY (`delivery_receipt_id`) REFERENCES `delivery_receipt` (`id`);
