...
if($result->num_rows>0){
    while($row = $result->fetch_assoc()){
        ...
        if(strpos($description, 'KRS') !== false){
            $brand_name = "KRS - EASTWAY";
        }
        ...
        echo "model :" . $part_code . "<br>";
        echo "dealer : " . $dealer . "<br>";
        echo "wholesale : " . $item_wholesale . "<br>";
        echo "price : ". $srp . "<br>";
        echo "unit : ". $unit . "<br>";
