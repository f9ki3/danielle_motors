...
foreach ($items as $item) {
    ...
    $check_if_product_exist = "SELECT * FROM product WHERE `name` = '$item_description' LIMIT 1";
    ...
    if($first_res->num_rows>0){
        ...
        $insert_to_product = "INSERT INTO product SET `name` = '$item_description', active = 1, publish_by = '$publish_by'";
