...
if (isset($_GET['edit'])) {
    ...
    switch ($edit_action) {
        ...
        case 'wholesale':
            ...
            $update_query = "UPDATE product SET wholesale = '$new_wholesale_price' WHERE id = '$product_id'";
            $conn->query($update_query);
            break;
        ...
        case 'srp':
            ...
            $update_query = "UPDATE product SET srp = '$new_srp_price' WHERE id = '$product_id'";
            $conn->query($update_query);
            break;
