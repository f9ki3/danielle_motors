...
<!-- Mirrored from prium.github.io/phoenix/v1.13.0/pages/starter.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Aug 2023 05:15:12 GMT -->
...
<head>
  ...
  <body>
    ...
    <main class="main" id="top">
      <!-- navigation -->
      <?php include "../page-properties/nav.php";?>
      <!-- /navigation -->
      <div class="content">
        ...
        <!-- footer -->
        <?php include "../page-properties/footer.php"; ?>
        <!-- /footer -->
      </div>
      <!-- chat-container -->
      <?php include "../page-properties/chat-container.php"; ?>
      <!-- /chat container -->
    </main><!-- ===============================================-->
    <!--    End of Main Content-->
    <!-- ===============================================-->
    ...
    <!-- theme customizer -->
    <?php include "../page-properties/theme-customizer.php"; ?>
    <!-- /theme customizer -->
