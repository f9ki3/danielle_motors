...
<div style="width: 100%" class="content p-3">
    <div>
        <div style="background-color: white;" class="rounded border p-3 mb-3 w-100">
            ...
            <button class="btn btn-sm border rounded mb-2">All Sales</button>
            <button class="btn btn-sm border rounded mb-2">Walk-in Sales</button>
            ...
            <div class="row">
                ...
                <div class="p-1">
                    <table class="table mt-3">
                        <thead>
                            <tr>
                            <th scope="col" width="10%" class="product_id">Product Id</th>
                            <th scope="col" width="20%" class="product_img">Image</th>
                            <th scope="col" width="40%">Product Name</th>
                            <th scope="col" width="10%">Stocks</th>
                            <th scope="col" width="20%" class="text-end">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                        <tr>
